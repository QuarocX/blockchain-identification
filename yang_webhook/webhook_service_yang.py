...
def home():
    return 'Hello, This is Home for yang!'


@app.route('/webhooks/', methods=['GET', 'POST'])
def webhooks():
    return 'Hello, This is the webhooks main page for yang!'


@app.route('/webhooks/topic/ping/', methods=['GET', 'POST'])
def webhooks_ping():
    return 'Hello, Webhooks is pinged for yang!'
...
def webhooks_topic_basicmessages():
    if request.method == 'POST':
        ...
        return 'Hello, This is the webhooks topic page for the basic messages for yang!'
...
def webhooks_topic_connections():
    if request.method == 'POST':
        ...
        return 'Hello, This is the webhooks topic page for the connections for yang!'


@app.route('/webhooks/topic/connections/<conn_id>/', methods=['GET', 'POST'])
def webhooks_topic(conn_id):
    if request.method == 'POST':
        return request.json
    else:
        return 'Hello, This is the webhooks topic page for the connection %s for yang!' % conn_id
