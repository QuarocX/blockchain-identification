...
contract IDUnionAuthenticator {
    ...
    string private credentials =  '{"proof_requests":[{"name":"Proof of attributes","attributes":{"names":["firstName","familyName","addressStreet","addressCity","placeOfBirth","dateOfExpiry","dateOfBirth","addressZipCode","addressCountry"]},"cred_def":{"restriction":[{"cred_def_id":"ELMkCtYoz86qnJKeQqrL1M:3:CL:5574:Online-ID Demo"}]}},{"name":"Proof of age","attributes_restrictions":{"dateOfBirth":{"name":"dateOfBirth","p_type":"<=","p_value":20030101,"restrictions":[{"cred_def_id":"ELMkCtYoz86qnJKeQqrL1M:3:CL:5574:Online-ID Demo"}]},"ZipCodeSmall":{"name":"addressZipCode","p_type":"<=","p_value":14199,"restrictions":[{"cred_def_id":"ELMkCtYoz86qnJKeQqrL1M:3:CL:5574:Online-ID Demo"}]},"ZipCodeBig":{"name":"addressZipCode","p_type":">=","p_value":10115,"restrictions":[{"cred_def_id":"ELMkCtYoz86qnJKeQqrL1M:3:CL:5574:Online-ID Demo"}]}},"cred_def":{"restriction":[{"cred_def_id":"ELMkCtYoz86qnJKeQqrL1M:3:CL:5574:Online-ID Demo"}]}}]}';
    /*
